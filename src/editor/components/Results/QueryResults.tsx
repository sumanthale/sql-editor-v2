...
export function QueryResults({ results, isLoading, lastExecuted }: QueryResultsProps) {
    ...
    return (
      <div className="h-full bg-white/90 dark:bg-slate-800/90 backdrop-blur-sm border-t border-slate-200/60 dark:border-slate-700/60 flex items-center justify-center">
        <div className="flex items-center gap-4 bg-white/80 dark:bg-slate-800/80 backdrop-blur-md px-6 py-4 rounded-xl shadow-lg border border-slate-200/60 dark:border-slate-700/60">
          ...
          <div>
            <div className="font-semibold text-slate-700 dark:text-slate-300">Executing query...</div>
            <div className="text-sm text-slate-500 dark:text-slate-400">Please wait while we process your request</div>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className="h-full bg-white/90 dark:bg-slate-800/90 backdrop-blur-sm border-t border-slate-200/60 dark:border-slate-700/60 flex flex-col">
      {/* Header */}
      <div className="p-4 border-b border-slate-200/60 dark:border-slate-700/60 bg-gradient-to-r from-slate-50/80 to-white/80 dark:from-slate-800/80 dark:to-slate-700/80 backdrop-blur-sm flex-shrink-0">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="flex items-center gap-2 px-3 py-2 text-sm bg-slate-100 dark:bg-slate-700 hover:bg-slate-200 dark:hover:bg-slate-600 disabled:opacity-50 disabled:cursor-not-allowed rounded-lg transition-all duration-200 font-medium text-slate-700 dark:text-slate-300"
            >
              <FileText size={14} />
              CSV
            </button>
        ...
        {!currentResult ? (
          <div className="h-full flex items-center justify-center">
            <div className="text-center max-w-md">
              ...
              <h3 className="text-xl font-semibold text-slate-700 dark:text-slate-300 mb-2">No query results</h3>
              <p className="text-slate-500 dark:text-slate-400 mb-1">Run a SQL query to see the data results here</p>
              <p className="text-sm text-slate-400 dark:text-slate-500">Use Ctrl+Enter to execute your query</p>
            </div>
          </div>
          ...
          <div className="h-full flex items-center justify-center">
            <div className="text-center max-w-md">
              ...
              <h3 className="text-xl font-semibold text-slate-700 dark:text-slate-300 mb-2">Query executed successfully</h3>
              <p className="text-slate-500 dark:text-slate-400 mb-4">No rows returned from your query</p>
      ...
      {currentResult && (
        <div className="px-4 py-3 border-t border-slate-200/60 dark:border-slate-700/60 bg-gradient-to-r from-slate-50/80 to-white/80 dark:from-slate-800/80 dark:to-slate-700/80 backdrop-blur-sm flex-shrink-0">
          <div className="flex items-center justify-between">
            ...
            <div className="text-xs text-slate-500 dark:text-slate-400 ml-4 flex-shrink-0 bg-slate-100 dark:bg-slate-700 px-3 py-1.5 rounded-lg">
